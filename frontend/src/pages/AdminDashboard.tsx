    ...
    <div className="min-h-screen pt-20 flex bg-background">
      ...
      <AnimatePresence>
        {showAlertModal && (
          ...
          >
            <div className="modal-card bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-700 rounded-3xl max-w-md w-full p-6 md:p-8 shadow-2xl relative text-foreground z-50">
