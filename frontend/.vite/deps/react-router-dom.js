...
import { t as require_react_dom } from "./react-dom-CHQ5_BF3.js";
...
function useFetcher(_temp3) {
	...
	routeId ?? invariant(false, "useFetcher can only be used on routes that contain a unique \"id\"");
...
function useViewTransitionState(to, opts) {
	...
	vtContext ?? invariant(false, "`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");
